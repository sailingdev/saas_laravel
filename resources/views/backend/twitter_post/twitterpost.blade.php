    ...
    <div class="subheader {{Helper::class_main(1)}}">
        <div class="wrap">
            <div class="subheader-main">
                <button type="button" class="btn btn-label-info m-r-10 subheader-toggle">
                    <i class="fas fa-bars"></i>
                </button>
                <h3 class="title">
                    <i class="fab fa-twitter text-info"></i> Twitter Post
                </h3>
                <button type="button" class="btn btn-label-info subheader-right-toggle">
                        ...
                        <div class="item col p-l-0 p-r-0 active">
                            <a href="javascript:void(0);">
                                <label class="i-radio i-radio--tick i-radio--brand m-b-0 p-l-0">
                                    <input type="radio" name="post_type" checked="" value="photo"> <i class="fas fa-images"></i> Photo					<span class="d-none"></span>
                                </label>
                            </a>
                        </div>
                            ...
                            <div class="advance-content">
                                <div class="form-group widget-location">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control search-location" data-action="{{url('twitter_post/location')}}" data-hide-overplay="false" data-result="html" data-content="load-location" type="text" autocomplete="off" placeholder="Enter location">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datetime hasDatepicker" autocomplete="off" name="time_post" value="" id="dp1661310210186">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                            ...
                            <div class="row post-repost">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datetime hasDatepicker" autocomplete="off" name="repost_until" value="" id="dp1661310210187">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col p-0">
                            <div class="post-preview">
                                <div class="tab nav nav-tabs">
                                    <a href="#preview-tab-0" class="active" data-toggle="tab" aria-expanded="true"><i class="fab fa-twitter" style="color: #00acee"></i></a>
                                </div>
                                                    ...
                                                    <div class="card-body p-0">
                                                        <div class="preview-twitter preview-twitter-photo item-post-type" data-type="media" style="display: none;">
                                                            <div class="preview-content">
                                                                ...
                                                                <div class="post-info">
                                                                    <div class="info-active">3:03 AM 24 Aug, 2022</div>
